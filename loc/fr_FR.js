module.exports = {
  ...
  send: {
    ...
    details: {
      ...
      address: 'adresse',
      amount_placeholder: 'montant à envoyer (en KSOC)',
      fee_placeholder: 'plus frais de transaction (en KSOC)',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'votre mot de passe. Pour protéger vos biens, Ksoc permet de créer un autre ' +
      ...
      "Ksoc, débloquera se 'faux' espace de stockage. Le tiers pourra " +
