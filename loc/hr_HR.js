module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'unesi',
      explanation:
        'Ovdje upiši svoj mnemonik slijed riječi, privatni ključ, WIF, ili što već imaš. Ksoc će pokušati porocijeniti format i unesti tvoj volet.',
      imported: 'Uneseno',
  ...
  send: {
    ...
    details: {
      ...
      address: 'adresa',
      amount_placeholder: 'iznos za slanje (u KSOC)',
      fee_placeholder: 'plus trošak transakcije (u KSOC)',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'Ksoc ti čuva leđa buraz. Nemaš brige. Gledaj, ' +
