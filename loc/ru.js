module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'Импорт',
      explanation:
        'Напиши тут свою мнемоническую фразу, приватный ключ, WIF - что угодно! Ksoc постарается угадать верный формат',
  ...
  send: {
    ...
    details: {
      ...
      amount_placeholder: 'сколько отправить (в KSOC)',
      fee_placeholder: 'плюс комиссия за перевод (в KSOC)',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'Чтобы сохранить свой Bitcoin в безопасности, Ksoc может создать ' +
      ...
      "Ksoc, разблокируется 'фальшивое' хранилище. Это будет выглядеть " +
