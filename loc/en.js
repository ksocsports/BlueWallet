module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'import',
      explanation:
        "Write here your mnemonic, private key, WIF, or anything you've got. Ksoc will do its best to guess the correct format and import your wallet",
      imported: 'Imported',
  ...
  send: {
    ...
    details: {
      ...
      address: 'address',
      amount_placeholder: 'amount to send (in KSOC)',
      fee_placeholder: 'plus transaction fee (in KSOC)',
  ...
  plausibledeniability: {
    ...
    help:
      'Under certain circumstances, you might be forced to disclose a password. To keep your coins safe, Ksoc can create another encrypted storage, with a different password. Under pressure, you can disclose this password to a 3rd party. If entered in Ksoc, it will unlock new fake storage. This will seem legit to a 3rd party, but will secretly keep your main storage with coins safe.',
    help2:
