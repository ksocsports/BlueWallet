module.exports = {
  ...
  send: {
    ...
    details: {
      ...
      amount_placeholder: 'quantia a enviar (em KSOC)',
      fee_placeholder: 'mais a taxa de transacção (em KSOC)',
  ...
  settings: {
    ...
    lightning_settings_explain:
      ...
      ' e copiar sua URL para cá. Deixe em branco para usar a LndHub padrão fornecida pela Ksoc (lndhub.io).' +
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'senha. Para manter seus bitcoins seguros, A Ksoc pode criar ' +
      'uma senha alternativa. Sob pressão, você pode revelar essa senha ao ' +
      'invés da senha principal. Quando inserida na Ksoc, esta abrirá ' +
