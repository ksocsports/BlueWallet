module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: '导入',
      explanation: '输入你的助记词，私钥，WIF，或者其他格式的数据。Ksoc将尽可能地自动识别格式并导入钱包。',
      imported: '已经导入',
  ...
  send: {
    ...
    details: {
      ...
      address: '地址',
      amount_placeholder: '发送金额(in KSOC)',
      fee_placeholder: '加上手续费用 (in KSOC)',
  ...
  plausibledeniability: {
    title: '可否认性',
    help:
      '在某些情况下，您可能被迫透露密码。 为了确保您的比特币安全，Ksoc可以创建另一个具有不同密码的加密存储。 在被胁迫情况下下，您可以将此密码透露给第三者。 如果在Veles Wallet中输入，它将解锁新的虚拟存储。 这对于第三方来说似乎合法，但是会秘密地将您的比特币存放在安全的地方。',
