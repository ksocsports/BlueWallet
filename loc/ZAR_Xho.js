module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'ukungenisa',
      explanation:
        'Bhale apha imnemonic yakho, ngundoqo, WIF , okanye nantoni na onayo. Ksoc uya kwenza konke okusemandleni ukuqiqa ifomathi efanelekileyo kwaye ingenise ingxowa yakho',
      imported: 'Ngenisiwe',
  ...
  send: {
    ...
    details: {
      ...
      address: 'idilesi',
      amount_placeholder: 'inani lokuthumela (nge KSOC)',
      fee_placeholder: 'kunye nentlawulo yokuthengiswa (nge KSOC)',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'inombolo yokuvula. Ksoc ukugcina imali yakho ikhuselekile, unokudala enye ' +
      ...
      'Ksoc, iya kuvula ukugcinwa kwetyala ‘entsha’. Oku kuya kubonakala ' +
