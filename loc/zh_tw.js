module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: '匯入',
      explanation: '輸入你的助記詞，私鑰或者WIF, 或者其他格式的資料. Ksoc將盡可能的自動識別資料格式並匯入錢包',
      imported: '已經匯入',
  ...
  send: {
    ...
    details: {
      ...
      address: '地址',
      amount_placeholder: '傳送金額(in KSOC)',
      fee_placeholder: '手續費用 (in KSOC)',
      note_placeholder: '訊息',
      cancel: '取消',
      scan: '掃描',
      send: '傳送',
  ...
  plausibledeniability: {
    ...
    help:
      '在某些情況下, 你不得不暴露 ' +
      '密碼. 為了讓你的比特幣更加安全, Ksoc可以建立一些 ' +
      '加密空間, 用不同的密碼. 在壓力之下, ' +
      '你可以暴露這個錢包密碼. 再次進入 ' +
      'Ksoc, 我們會解鎖一些虛擬空間. 對第三方來說看上去' +
