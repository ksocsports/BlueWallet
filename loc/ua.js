module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'імпорт',
      explanation: 'Мнемоніка, приватний ключ, чи будь що. Ksoc спробуе вгадати вірний формат',
      imported: 'імпортовано',
  ...
  send: {
    ...
    details: {
      ...
      amount_placeholder: 'скільки відправити (в KSOC)',
      fee_placeholder: 'плюс комісія за переказ (в KSOC)',
