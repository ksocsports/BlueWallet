module.exports = {
  ...
  settings: {
    ...
    lightning_settings_explain:
      ...
      'Deixe em branco para usar o LNDHub da Ksoc (lndhub.io). ' +
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'password. Para manter as suas moedas seguras, A Ksoc pode criar outro ' +
      'armazenamento encriptado, com uma password diferente. Sobre pressão, ' +
      'pode revelar esta password a um terceiro. Se inserida na ' +
      'Ksoc, esta vai abrir um armazenamento "falso". Que vai parecer ' +
