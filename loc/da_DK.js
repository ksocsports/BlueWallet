module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'importer',
      explanation:
        'Indtast din huskeregel, private nøgle, WIF, eller hvad du end har. Ksoc vil forsøge at gætte det rigtige format og importere din wallet',
      imported: 'Importeret',
  ...
  send: {
    ...
    details: {
      ...
      address: 'adresse',
      amount_placeholder: 'beløb der skal sendes (i KSOC)',
      fee_placeholder: 'plus transaktionsgebyr (i KSOC)',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'adgangskode. For at beskytte dine coins kan du med Ksoc lave ' +
      ...
      'Ksoc, vil brugeren se den alternative wallet. Det vil se helt' +
