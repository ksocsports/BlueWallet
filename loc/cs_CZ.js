module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'importovat',
      explanation:
        'Zadejte zde svůj mnemonic seed, privátní klíč, WIF, nebo cokoliv co máte. Ksoc se pokusí uhodnout správný formát a naimportovat vaší peněženku',
  ...
  send: {
    ...
    details: {
      ...
      address: 'adresa',
      amount_placeholder: 'částka k odeslání (v KSOC)',
      fee_placeholder: 'plus transakční poplatek (v KSOC)',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'K zajištění bezpečností vašich prostředků, Ksoc může vytvořit' +
      'další zašifrované úložiště s rozdílný heslem. V případě potřeby' +
      'můžete toto heslo dát třetí straně. Pokud bude zadáno do Ksoc,' +
