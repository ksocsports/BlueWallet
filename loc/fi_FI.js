module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'tuo',
      explanation:
        'Kirjoita tähän muistisanasi, private key, WIF tai jotain mitä sinulla on. Ksoc tekee parhaansa arvatakseen oikean muodon ja tuo lompakkosi',
      imported: 'Tuotu',
  ...
  send: {
    ...
    details: {
      ...
      address: 'osoite',
      amount_placeholder: 'lähetettävä summa (KSOC)',
      fee_placeholder: 'plus siirtokulu (KSOC)',
  ...
  settings: {
    ...
    lightning_settings_explain:
      ...
      ' ja laita sen URL tänne. Jätä tyhjäksi käyttääksesi Ksocin LNDHubia (lndhub.io). Muutosten tallentamisen jälkeen luodut lompakot yhdistävät annettuun LNDHubiin.',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'salasanasi. Pitääksesi kolikkosi turvassa, Ksoc voi luoda toisen ' +
      'salatun tallennustilan, toisella salasanalla. Paineen alla, ' +
      'voit kertoa tämän salasanan kolmannelle osapuolelle. Annettaessa ' +
      'Ksociin, se avaa uuden väärennetyn tallennustilan. Se näyttää ' +
