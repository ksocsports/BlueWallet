module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'Invoer',
      explanation:
        'Sleutel mnemonic, privaat sleutel, WIF, of enige text verwysing. Ksoc sal die korrekte formaat kies en u beursie importeer ',
  ...
  send: {
    ...
    details: {
      ...
      address: 'adres',
      amount_placeholder: 'bedrag om te stuur (in KSOC)',
      fee_placeholder: 'plus transaksie fooi (in KSOC)',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'wagwoord te deel teen u wil. Om u te beskerm kan Ksoc ‘n ' +
