module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'インポート',
      explanation:
        'ここにニーモニック、秘密鍵(プライベートキー）、WIFなどを入力してください。Ksoc が正しい形式を推測しウォレットをインポートします。',
      imported: 'インポート完了',
  ...
  send: {
    ...
    details: {
      ...
      address: 'アドレス',
      amount_placeholder: '送金額 (KSOC)',
      fee_placeholder: '取引手数料 (KSOC)',
  ...
  plausibledeniability: {
    title: '拒否権',
    help:
      'BuleWallet のウォレットの復号に必要なパスワードを第三者に強要される場合、コインを安全に保護するためにメインのウォレットとは異なるパスワードで 暗号化されたダミーのウォレットを作成することが可能です。第三者へ異なるパスワードを提供すれば、Ksoc のダミーの 暗号化ウォレットを復号することとなり、メインのウォレットは隠匿され コインは安全に保護されます。',
    help2:
