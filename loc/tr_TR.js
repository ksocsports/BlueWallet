module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'içeri yükle',
      explanation:
        'Buraya cüzdan yedek cümlenizi, gizli anahtarınızı, WIF veya diğer bilginizi yazın. Ksoc elinden gelen en iyi tahmini yaparak cüzdanınızı içeri aktarmaya çalışacak.',
  ...
  send: {
    ...
    details: {
      ...
      address: 'adres',
      amount_placeholder: 'gönderilecek miktar (KSOC cinsinden)',
      fee_placeholder: 'artı işlem ücreti (KSOC cinsinden)',
  ...
  settings: {
    ...
    lightning_settings_explain:
      ...
      " ve URL’sini buraya, ayarlara yazın. Ksoc'in LNDHub (lndhub.io) programını kullanmak için boş bırakın. Değişiklikleri kaydettikten sonra oluşturulan cüzdanlar belirtilen LNDHub'a bağlanacaktır.",
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'Paralarınızı güvende tutmak için, Ksoc başka bir şifre ile ' +
      'şifreli depolama alanı yaratabilir. Baskı altında, ' +
      'Bu şifreyi 3. bir tarafa söyleyebilirsiniz. Girilirse ' +
      "Ksoc, yeni 'sahte' bir depolamanın kilidini açacaktır. Bu 3. şahıslara " +
