module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'nhập',
      explanation:
        'Viết ở đây bản ghi nhớ, khóa riêng, WIF hoặc bất cứ thứ gì quý khách có. Ksoc sẽ cố hết sức để đoán đúng định dạng và nhập ví của quý khách',
      imported: 'Đã nhập',
  ...
  send: {
    ...
    details: {
      ...
      address: 'địa chỉ',
      amount_placeholder: 'số tiền gửi ( bằng KSOC)',
      fee_placeholder: 'cộng thêm phí giao dịch ( bằng KSOC)',
  ...
  plausibledeniability: {
    ...
    help:
      'Trong một số trường hợp nhất định, quý khách có thể bắt buộc phải tiết lộ mật khẩu. Để giữ tiền xu của quý khách được an toàn, Ksoc có thể tạo một bộ lưu trữ được mã hóa khác, với một mật khẩu khác. Dưới áp lực, quý khách có thể tiết lộ mật khẩu này cho bên thứ ba. Nếu được nhập vào Ksoc, nó sẽ mở khóa bộ nhớ giả mới. Điều này có vẻ hợp pháp với bên thứ ba nhưng sẽ bí mật giữ bộ nhớ chính của quý khách với tiền xu an toàn',
    help2:
