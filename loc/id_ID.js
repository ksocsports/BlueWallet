module.exports = {
  ...
  wallets: {
    ...
    add: {
      title: 'tambah dompet',
      description:
        'Kamu bisa membuat dompet atau memindai paper wallet dalam WIF (Wallet Import Format). Ksoc mendukung dompet Segwit.',
      scan: 'Pindai',
      create: 'Buat',
    ...
    import: {
      title: 'impor',
      explanation:
        'Ketik kata mnemonic, private key, WIF, atau apapun yang kamu punya. Ksoc akan mencoba mengimpor dompet kamu.',
      imported: 'Diimpor',
  ...
  send: {
    ...
    details: {
      ...
      address: 'alamat',
      amount_placeholder: 'jumlah (dalam KSOC)',
      fee_placeholder: 'Tambahan biaya transaksi (dalam KSOC)',
