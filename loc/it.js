module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'Importa',
      explanation:
        'Scrivi qui la tua frase mnemonica, chiave privata, WIF, o qualunque altra cosa tu abbia. Ksoc tenterà di indovinare il formato corretto e importerà il tuo portafoglio',
      imported: 'Importato',
  ...
  send: {
    ...
    details: {
      ...
      address: 'Indirizzo',
      amount_placeholder: 'Importo da inviare (in KSOC)',
      fee_placeholder: 'Più commissione (in KSOC)',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'password. Per mantenere i tuoi Bitcoin al sicuro, Ksoc può creare un altro ' +
      'archivio criptato, con una password diversa. Se costretto, ' +
      'puoi rivelare questa password alle terze parti. Se inserita in ' +
      'Ksoc, questa sbloccherà un "falso" archivio. Esso sembrerà ' +
